...
export function messageDialog(error: unknown, title = "No fue posible continuar"): Promise<void> {
  return new Promise((resolve) => {
    ...
    overlay.innerHTML = `<section class="sam-modal corporate-modal message-modal" role="alertdialog" aria-modal="true">
      ...
      <footer class="corporate-modal-footer"><button type="button" class="primary-action" data-answer="close">Entendido</button></footer>
    </section>`;
